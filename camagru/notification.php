...
<!DOCTYPE html> 
 <html>
	<head>
		<title>Notifications - Camagru</title>
		  <meta charset="UTF-8" />
		...
		<?php if($data->type == 'like') :?>
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet"> 
						<a href="<?php echo BASE_URL.$data->profileImage;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> liked your <?php if($data->tweetBy === $user_id){echo 'Post';}else{echo 'Retweet';}?> - <span><?php echo $getFromU->timeAgo($data->time);?></span>
					</div>
		...
		<?php if($data->type == 'retweet') :?>
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet"> 
						<a href="<?php echo BASE_URL.$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> retweet your <?php if($data->tweetBy === $user_id){echo 'Post';}else{echo 'Retweet';}?> - <span><?php echo $getFromU->timeAgo($data->time);?></span>
					</div>
					<div class="notification-footer">
						<div class="noti-footer-inner">
